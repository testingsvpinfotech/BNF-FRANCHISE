                    ...
                    <div class="col-12 col-md-12 mt-3">
                        <div class="card p-4">
                            <div class="card-body">
                                ...
                                <?php if(!empty($franchise_data)){ ?>
                                <form name="form" action="<?php echo base_url();?>FranchiseController/store_franchise_data" method="POST" >
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <label>Username</label>
                                                 <input type="text" class="form-control" name="username" placeholder="Enter Username" value="<?php echo $franchise_data->username ; ?>" >
                                            </div>
                                        </div>
                                    </div>
                                    <!--<div class="col-md-3">-->
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="franchise_name" placeholder="Enter Name" value="<?php echo $franchise_data->franchise_name ; ?>" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" placeholder="Enter Email-Id"  value="<?php echo $franchise_data->email ; ?>" class="form-control">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group ">
                                            ...
                                            <textarea class="form-control" autocomplete="nope" rows="5" name="address" placeholder ="Enter Your Addres.."> <?php echo $franchise_data->address ; ?> </textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text"  name="pincode" id="pincode"  value="<?php echo $franchise_data->pincode ; ?>"  class="form-control" placeholder="Enter Pincode Number">
                                            ...
                                            <div class="form-group col-md-4 ">
                                                ...
                                                <input type="text" autocomplete="nope" name="contact_number"  value="<?php echo $franchise_data->contact_number ; ?>" pattern='^\+?\d{0,10}' class="form-control"  title ="please check Contact Number" placeholder="contact_number" required>
                                            </div>
                                            <div class="form-group col-md-4 ">
                                                <label class="control-label">Alternate Contact No</label>
                                                <input type="text" autocomplete="nope" name="alt_contact"  value="<?php echo $franchise_data->alt_contact ; ?>" class="form-control" pattern='^\+?\d{0,10}' title ="please check Alternate Contact Number" placeholder="Enter Alt Number">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <select class="form-control" name="companytype" required>
                                                    ...
                                                    <option value="Sole Proprietorship" <?php if($franchise_data->companytype == 'Sole Proprietorship'){ echo 'selected';}?>>Sole Proprietorship</option>
                                                    <option value="Partnership" <?php if($franchise_data->companytype == 'Partnership'){ echo 'selected';}?>>Partnership</option>
                                                    <option value="Limited Liability Partnership" <?php if($franchise_data->companytype == 'Limited Liability Partnership'){ echo 'selected';}?>>Limited Liability Partnership</option>
                                                    <option value="Public Limited Company" <?php if($franchise_data->companytype == 'Public Limited Company'){ echo 'selected';}?>>Public Limited Company</option>
                                                    <option value="Private Limited Company" <?php if($franchise_data->companytype == 'Private Limited Company'){ echo 'selected';}?>>Private Limited Company</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
