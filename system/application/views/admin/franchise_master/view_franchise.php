                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $cust['fid']; ?></td>
                                                    <td><?php echo $cust['franchise_name']; ?></td>
                                                    ...
                                                    <td>
                                                        <a href="<?php base_url(); ?>admin/update-franchise/<?php echo $cust['franchise_id']; ?>" title="view"><i class="ion-edit" style="color:#ddd;"></i></a>
                                                        |
