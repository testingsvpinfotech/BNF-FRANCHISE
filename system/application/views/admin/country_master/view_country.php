                                      ...
                                      <tbody>                             
                                        <?php 
                                          ...
                                          <td> 
                                            ...
                                            <a href="javascript:void(0)" relid = "<?php echo $cntry['country_id'];?>" title="Delete" class="deletedata"><i class="ion-trash-b" style="color:var(--danger)"></i></a>
      ...
      // alert(getid);
       var baseurl = '<?php echo base_url();?>'
       	swal({
		  	...
		  	if (result.value){
		  		$.ajax({
			   		url: baseurl+'Admin_country/delete_country',
			    	type: 'POST',
			       	data: 'getid='+getid,
			       	dataType: 'json'
			    })
